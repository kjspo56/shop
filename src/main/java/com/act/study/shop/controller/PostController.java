package com.act.study.shop.controller;

import com.act.study.shop.domain.entity.User;
import com.act.study.shop.dto.PostDTO;
import com.act.study.shop.service.PostService;
import com.act.study.shop.service.UserService;
...
public class PostController {
    ...
    public ResponseEntity register(@RequestBody PostDTO postDTO) {
        log.info("title = {}, contents = {}, userId = {}", postDTO.getPostTitle(), postDTO.getPostContents(), postDTO.getUserId());
    ...
    public ResponseEntity postUpdate(@PathVariable Long postId, @RequestBody PostDTO postDTO) {
        ...
        log.info("update title = {}, update contents = {}", postDTO.getPostTitle(), postDTO.getPostContents());
